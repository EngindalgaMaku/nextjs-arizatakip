...
import OkulOgrenciListesi from '@/components/dashboard/OkulOgrenciListesi';
...
export default async function DashboardPage() {
  try {
    ...
    const isTeacher = userRole === UserRole.TEACHER || userRole === UserRole.SUBSTITUTE_TEACHER;
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="mb-6">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
              {school?.name ? `${school.name} Dashboard` : 'Okul Yönetim Sistemi'}
            </h1>
            <p className="text-gray-600">Okulla ilgili genel istatistikler ve güncel bilgiler</p>
